...
export function writeManifest(repoRoot, { versions, layers, languages }) {
  ...
  const body = {
    ...
    _note: 'Committed contract. A teammate installs CoMind (npx -y @comind-dev/comind@latest) then runs /comind-init, and gets exactly these versions. Do not hand-edit — bump versions.json and re-run setup.',
  };
