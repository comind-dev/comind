 ...
 *
 * The two-stage split makes this distinction load-bearing: `npx comind` installs
 ...
 * downloaded rtk binary, so every `npx comind` deleted rtk as a stale artifact.
